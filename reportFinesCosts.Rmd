...
Total Amount Owed, FJD has no address | $`r totalOwedNoAddress` (`r 100*round(totalOwedNoAddress/totalOwed,0)`% of total owed) | $`r totalOwedNoAddressActive` (`r 100*round(totalOwedNoAddressActive/(totalOwed - totalOwedReferred),0)`% of total owed)| $`r totalOwedNoAddressReferred` (`r 100*round(totalOwedNoAddressReferred/totalOwedReferred,0)`% of total owed)
...
Total Amount Delinquent, FJD has no address | $`r totalDelinquentNoAddress` (`r 100*round(totalDelinquentNoAddress/totalDelinquent,0)`% of total delinquent) | $`r totalDelinquentNoAddressActive` (`r 100*round(totalDelinquentNoAddressActive/(totalDelinquent-totalDelinquentReferred),0)`% of total delinquent) | $`r totalDelinquentNoAddressReferred` (`r 100*round(totalDelinquentNoAddressReferred/totalDelinquentReferred,0)`% of total delinquent)
