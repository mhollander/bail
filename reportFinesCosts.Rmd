...
Median months in Arrears | `r median(fcdata$MonthlyPaymentsBehind[fcdata$MonthlyPayment > 0])` | `r summariseFcdata$MonthlyPaymentsBehind[summariseFcdata$Status=="Active"]` | `r summariseFcdata$MonthlyPaymentsBehind[summariseFcdata$Status=="Referred"]`
